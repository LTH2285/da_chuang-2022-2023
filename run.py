...
class Run:
    def __init__(self, config):
        ...
        self.train_path = f"{self.root_path}train.pkl"
        self.val_path = f"{self.root_path}val.pkl"
        self.test_path = f"{self.root_path}test.pkl"
    ...
    def config2dict(self):
        return dict(self.configinfo.items())
        # config_dict = {}
